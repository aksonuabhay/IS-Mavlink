...
import com.MAVLink.Messages.MAVLinkPayload;
        ...
        */
        ...
        payload.resetIndex();
        	    this.cam_id = payload.getLong();
        	    this.timestamp = payload.getLong();
        	    this.valid_until = payload.getLong();
        	    this.img_seq = payload.getInt();
        	    this.img_buf_index = payload.getInt();
        	    this.key = payload.getInt();
        	    this.exposure = payload.getInt();
        	    this.gain = payload.getFloat();
        	    ...
        	    this.ground_x = payload.getFloat();
        	    this.ground_y = payload.getFloat();
        	    this.ground_z = payload.getFloat();
        	    this.width = payload.getShort();
        	    this.height = payload.getShort();
        	    this.depth = payload.getShort();
        	    this.cam_no = payload.getByte();
        	    this.channels = payload.getByte();
