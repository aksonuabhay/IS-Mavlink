...
import com.MAVLink.Messages.MAVLinkPayload;
        ...
        */
        ...
        payload.resetIndex();
        	    this.pid = payload.getInt();
        	    this.watchdog_id = payload.getShort();
        	    this.process_id = payload.getShort();
        	    this.crashes = payload.getShort();
        	    this.state = payload.getByte();
        	    this.muted = payload.getByte();
