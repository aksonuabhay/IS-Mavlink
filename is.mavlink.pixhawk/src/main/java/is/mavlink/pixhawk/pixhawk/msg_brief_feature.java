...
import com.MAVLink.Messages.MAVLinkPayload;
        ...
        */
        ...
        payload.resetIndex();
        	    ...
        	    this.response = payload.getFloat();
        	    this.size = payload.getShort();
        	    this.orientation = payload.getShort();
        	    this.orientation_assignment = payload.getByte();
        	     for (int i = 0; i < this.descriptor.length; i++) {
                    this.descriptor[i] = payload.getByte();
                    }
