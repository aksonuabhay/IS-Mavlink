        ...
        */
		...
		switch (msgid) {
			...
			return  new msg_gimbal_report_factory_tests_progress(this);
            		case msg_gopro_power_on.MAVLINK_MSG_ID_GOPRO_POWER_ON:
			return  new msg_gopro_power_on(this);
            		case msg_gopro_power_off.MAVLINK_MSG_ID_GOPRO_POWER_OFF:
			return  new msg_gopro_power_off(this);
            		case msg_gopro_command.MAVLINK_MSG_ID_GOPRO_COMMAND:
			return  new msg_gopro_command(this);
            		case msg_gopro_response.MAVLINK_MSG_ID_GOPRO_RESPONSE:
			return  new msg_gopro_response(this);
